...
namespace Oudidon
{
    public class Character : OudidonGameComponent
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            if (string.IsNullOrEmpty(_currentAnimationName))
                return;
            _spriteSheet.DrawAnimationFrame(_currentAnimationName, CurrentFrame, SpriteBatch, new Vector2(PixelPositionX, PixelPositionY), _currentRotation, _currentScale, _finalColors);
        }
